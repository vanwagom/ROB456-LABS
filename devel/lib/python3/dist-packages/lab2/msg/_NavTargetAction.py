...
"""autogenerated by genpy from lab2/NavTargetAction.msg. Do not edit."""
import codecs
import sys
...
class NavTargetAction(genpy.Message):
  _md5sum = "c814090e51084b0e0c0a179f0fbf8ddc"
  _type = "lab2/NavTargetAction"
...
float32 data"""
  ...
  _slot_types = ['lab2/NavTargetActionGoal','lab2/NavTargetActionResult','lab2/NavTargetActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NavTargetAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = lab2.msg.NavTargetActionGoal()
      if self.action_result is None:
        self.action_result = lab2.msg.NavTargetActionResult()
      if self.action_feedback is None:
        self.action_feedback = lab2.msg.NavTargetActionFeedback()
    else:
      self.action_goal = lab2.msg.NavTargetActionGoal()
      self.action_result = lab2.msg.NavTargetActionResult()
      self.action_feedback = lab2.msg.NavTargetActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3d3I().pack(_x.action_goal.goal.goal.point.x, _x.action_goal.goal.goal.point.y, _x.action_goal.goal.goal.point.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.distance.data
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.goal.point.x, _x.action_goal.goal.goal.point.y, _x.action_goal.goal.goal.point.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.distance.data,) = _get_struct_f().unpack(str[start:end])
      return self
